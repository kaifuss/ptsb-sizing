...
Также для каждого источника запрашивается время на сканирование 1 файла в виртуальной машине `time_to_scan` и количество образов, которыми будет сканироваться каждый файл с данного источника `iso_amount`.
