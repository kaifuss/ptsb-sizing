...
| part_multiplier | Коэффициент, на который необходимо домножить объем разделов для обеспечения работы файловой системы [документация вендора](https://help.ptsecurity.com/ru-RU/projects/sb/5.15/implementation/7280579211#_364005632) | 1.08 |
...
| part_multiplier | Коэффициент, на который необходимо домножить объем разделов для обеспечения работы файловой системы [документация вендора](https://help.ptsecurity.com/ru-RU/projects/sb/5.15/implementation/7280579211#_1840969711) | 1.08 |
| ssd_size    | Изначальный объем ssd диска в Гб, к которому будут прибавлено вычисленное необходимое место             | 0           |
| hdd_size    | Изначальный объем hdd диска в Гб, к которому будут прибавлено вычисленное необходимое место             | 0           |
...
| part_multiplier | Коэффициент, на который необходимо домножить объем разделов для обеспечения работы файловой системы [документация вендора](https://help.ptsecurity.com/ru-RU/projects/sb/5.15/implementation/7280579211#_1169466672) | 1.08 |
| ssd_size    | Изначальный объем ssd диска в Гб, к которому будут прибавлено вычисленное необходимое место             | 0           |
| hdd_size    | Изначальный объем hdd диска в Гб, к которому будут прибавлено вычисленное необходимое место             | 0           |
